...
const useFormField = () => {
  ...
  if (!fieldContext) throw new Error("useFormField deve essere usato dentro <FormField>");
...
const FormDescription = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    ...
    return <p ref={ref} id={formDescriptionId} className={cn("text-sm text-[#4b5563]", className)} {...props} />;
  }
);
